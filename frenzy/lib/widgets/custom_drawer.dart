...
import 'package:frenzy/screens/profile_screen.dart';
    ...
    return Drawer(
      child: Column(
        children: <Widget>[
             ...
             Positioned(
               ...
               child: Row(
                 ...
                 children: <Widget>[
                   ...
                   SizedBox(width: 6.0),
                   Text(
                     currentUser.name, style: TextStyle(
                     color: Colors.white,
                     fontSize: 25.0,
          ...
          _buildDrawerOption(Icon(Icons.dashboard),
              'Home', ()=>Navigator.pushReplacement(context,
                  MaterialPageRoute(
                    builder: (_)=>HomeScreen(),
                  ))),
          _buildDrawerOption(Icon(Icons.chat), 'Chat', (){}),
          _buildDrawerOption(Icon(Icons.location_on), 'Map', (){}),
          _buildDrawerOption(Icon(Icons.account_circle), 'Profile'
          ...
          _buildDrawerOption(Icon(Icons.settings), 'Settings', (){}),
           Expanded(
             child: Align(
               ...
               child: _buildDrawerOption(Icon(Icons.directions_run),
